...
class ServerMonitor
{
     ...
     * @return \stdClass
     */
    final public static function getMemory()
    {
        $obj = new \stdClass();
        $cmd = "free";
     ...
     * @return \stdClass
     */
    final public static function getDisk()
    {
        $obj = new \stdClass();
        $cmd = "df -h";
        exec($cmd . "  2>&1", $output, $return_val);
    ...
    final public static function humanFileSize($size, $unit = "")
    {
    ...
    final public static function getServerLoad()
    {
        $load = null;
